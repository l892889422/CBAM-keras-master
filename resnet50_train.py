...
if __name__ == "__main__":
    ...
    gen = keras.preprocessing.image.ImageDataGenerator()            #图片生成器
    ...
    finetuned_model.compile(optimizer=Adam(lr_schedule(0)), loss='categorical_crossentropy', metrics=['accuracy'])
